...
pub static APP_ID: &str = "io.github.xpn.xpn";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "xpn-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "io.github.xpn.xpn.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "xpn-backup-dev";
